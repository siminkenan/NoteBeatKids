...
export interface IStorage {
  ...
  getClassProgress(classId: string): Promise<Array<Student & { rhythmProgress?: StudentProgress; notesProgress?: StudentProgress; rhythmTrainerProgress?: StudentProgress }>>;
...
export class DatabaseStorage implements IStorage {
  ...
  async getClassProgress(classId: string): Promise<Array<Student & { rhythmProgress?: StudentProgress; notesProgress?: StudentProgress; rhythmTrainerProgress?: StudentProgress }>> {
    ...
    for (const student of studentList) {
      ...
      const rhythmTrainerProgress = progress.find(p => p.appType === 'rhythm_trainer');
      result.push({ ...student, rhythmProgress, notesProgress, rhythmTrainerProgress });
    }
    return result;
  }
