...
function setupVite(server, app) {
    return __awaiter(this, void 0, void 0, function () {
        var serverOptions, resolvedConfig, _a, vite;
        var _this = this;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    if (!(typeof vite_config_1.default === "function")) return [3 /*break*/, 2];
                    return [4 /*yield*/, vite_config_1.default({ command: "serve", mode: "development" })];
                case 1:
                    _a = _b.sent();
                    return [3 /*break*/, 3];
                case 2:
                    _a = vite_config_1.default;
                    _b.label = 3;
                case 3:
                    resolvedConfig = _a;
                    return [4 /*yield*/, (0, vite_1.createServer)(__assign(__assign({}, resolvedConfig), { configFile: false, customLogger: __assign(__assign({}, viteLogger), { error: function (msg, options) {
