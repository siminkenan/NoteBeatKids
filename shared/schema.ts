...
import { pgTable, text, varchar, integer, boolean, timestamp, uniqueIndex, json, index, primaryKey } from "drizzle-orm/pg-core";
...
export const sessionTable = pgTable("session", {
  ...
  primaryKey({ name: "session_pkey", columns: [t.sid] }),
