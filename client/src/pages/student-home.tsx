    ...
    >
      ...
      <div className="relative z-10 max-w-lg mx-auto px-4 py-6 flex flex-col min-h-screen">
        ...
        <div className="flex flex-col gap-5 flex-1">
          ...
          >
            <div className="w-16 h-16 flex items-center justify-center flex-shrink-0 bg-white/25 rounded-2xl">
              <span className="text-4xl">🥁</span>
            </div>
            <div>
              <h2 className="text-xl font-extrabold text-white">Ritim Antrenörü</h2>
              <p className="text-white/85 font-semibold text-sm">Dinle ve ritmi tekrarla! 🎵</p>
            </div>
          </motion.button>
        </div>
      </div>
